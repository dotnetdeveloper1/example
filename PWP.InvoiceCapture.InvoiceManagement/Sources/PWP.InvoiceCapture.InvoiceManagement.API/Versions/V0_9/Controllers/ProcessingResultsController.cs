...
using ProcessingResultv0_9 = PWP.InvoiceCapture.InvoiceManagement.API.Versions.V0_9.Models.InvoiceProcessingResult;
...
namespace PWP.InvoiceCapture.InvoiceManagement.API.Versions.V0_9.Controllers
{
    ...
    public class ProcessingResultsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetProcessingResultByIdAsync(int processingResultId, CancellationToken cancellationToken)
        {
            ...
            var mappedProcessingResult = ProcessingResultMapper.ToV0_9Model(processingResult);

            return Ok(
                new ApiResponse<ProcessingResultv0_9> { Data = mappedProcessingResult });
        }
        ...
        public async Task<IActionResult> GetProcessingResultsByInvoiceIdAsync(int invoiceId, CancellationToken cancellationToken)
        {
            ...
            var mappedProcessingResults = ProcessingResultMapper.ToV0_9Models(processingResults);

            return Ok(
                new ApiResponse<List<ProcessingResultv0_9>> { Data = mappedProcessingResults });
        }
