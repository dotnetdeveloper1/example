...
namespace PWP.InvoiceCapture.InvoiceManagement.DataAccess.Configurations
{
    internal class InvoiceProcessingResultConfiguration
    {
        public static void Configure(EntityTypeBuilder<InvoiceProcessingResult> entityBuilder)
        {
            ...
            entityBuilder
                .Property(processingResult => processingResult.TrainingFileCount)
            ...
            entityBuilder
               .Ignore(processingResult => processingResult.CultureName);

            entityBuilder
               .Ignore(processingResult => processingResult.VendorName);
        }
    }
}
